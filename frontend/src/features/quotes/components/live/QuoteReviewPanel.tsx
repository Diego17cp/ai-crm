import { FiInbox, FiCheckCircle, FiXCircle, FiFileText, FiAlertTriangle } from "react-icons/fi";
...
export const QuoteReviewPanel = ({ quoteId, isQueue, onTakeReview, onApprove, onReject }: Props) => {
            ...
            >
              <div className="space-y-2 py-1">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => onReject(quoteId, motivo)}
