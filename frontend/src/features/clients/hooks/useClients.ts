...
import type { ApiError, EstadoCivil, Sexo } from "@/core/types";
...
export const useClients = () => {
	...
	const useCreateClientMutation = (data: CreateLeadPayload) =>
		useMutation({
	...
	const useEditClientMutation = (id: number, data: UpdateLeadPayload) =>
		useMutation({
	...
	const useDeleteClientMutation = (id: number) =>
		useMutation({
