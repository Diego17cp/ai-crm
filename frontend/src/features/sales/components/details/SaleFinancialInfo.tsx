		...
		<div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm">
			<div className="p-6 border-b border-gray-100 dark:border-gray-800 bg-linear-to-b from-gray-50/50 to-white dark:from-gray-800/20 dark:to-gray-900">
				...
				<div className="flex flex-col">
					...
					<span className="text-4xl sm:text-5xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-pink-600 to-emerald-500 dark:from-pink-400 dark:to-emerald-400 tracking-tight pb-1">
			...
			{sale.tipo_pago === "CREDITO" && (
				<div className="p-6 space-y-4">
					<div className="flex justify-between items-center pl-3 pr-4 py-3 bg-pink-50/50 dark:bg-pink-900/10 rounded-xl border border-pink-100 dark:border-pink-900/30">
						<div className="flex items-center gap-2 text-pink-800 dark:text-pink-300">
							<FiCheckCircle size={18} />
							<span className="text-sm font-semibold">
								Cuota Inicial
							</span>
						</div>
						<span className="font-bold text-pink-900 dark:text-pink-400 text-lg">
