	...
	return (
		...
		>
			<Link
				...
				className="group flex flex-col md:flex-row items-start md:items-center justify-between p-5 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm hover:shadow-md hover:border-pink-200 dark:hover:border-pink-800/50 transition-all gap-4 sm:gap-6 cursor-pointer"
			>
				<div className="flex items-center gap-4 w-full md:w-3/12 shrink-0">
					<div className="w-10 h-10 rounded-full bg-pink-100 dark:bg-pink-900/30 flex items-center justify-center text-pink-600 dark:text-pink-400 shrink-0">
						<FiUser size={18} />
					</div>
					<div className="flex flex-col min-w-0">
						<p className="text-sm font-bold text-gray-900 dark:text-white truncate">
							{venta.cliente.persona.nombres}{" "}
							{venta.cliente.persona.apellidos}
						</p>
						<p className="text-xs text-gray-500 dark:text-gray-400 truncate">
							Doc: {venta.cliente.persona.numero}
						</p>
				...
				<div className="flex flex-col w-full md:w-3/12 border-l-2 md:border-l-0 pl-3 md:pl-0 border-pink-500 md:border-transparent min-w-0">
				...
				<div className="flex flex-col w-full md:w-2/12 shrink-0">
					<p className="text-lg font-bold text-pink-700 dark:text-pink-400 leading-tight">
				...
				<div className="flex items-center justify-between w-full md:w-auto md:flex-1 gap-4">
					<div className="flex flex-col gap-2">
						...
						<div className="flex items-center gap-1.5 text-xs font-medium text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 px-2 py-1 rounded-md w-max border border-gray-100 dark:border-gray-700">
							<FiFileText size={12} className="text-pink-500" />
							{venta.estado_contrato}
						</div>
					</div>
					<div className="p-2 rounded-xl bg-gray-50 dark:bg-gray-800 text-gray-400 group-hover:text-pink-600 group-hover:bg-pink-50 dark:group-hover:text-pink-400 dark:group-hover:bg-pink-900/30 transition-colors shrink-0">
