...
import { FiX, FiFolderPlus, FiAlertCircle } from "react-icons/fi";
...
export const CreateProjectModal = ({ isOpen, onClose }: Props) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const message = (err as ApiError)?.response?.data?.message || "Error al crear el proyecto.";
            setError(message);
        }
    };
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-gray-400">
                                            Ingresa los datos generales del inmueble
                                        </p>
                                    </div>
                                </div>
                                <button
