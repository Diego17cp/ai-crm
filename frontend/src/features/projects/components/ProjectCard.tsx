	...
	return (
		...
		>
			...
			<div className="flex justify-between items-start gap-4">
				<div className="flex flex-col gap-1.5 flex-1">
					<div className="flex items-center gap-2 flex-wrap">
						...
						<span
							className={`px-2.5 py-0.5 text-[10px] uppercase font-bold tracking-wider rounded-lg ${getBadgeStyle(project.estado)}`}
						>
							{project.estado}
						</span>
					</div>
			...
			<p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2 min-h-10">
				{project.descripcion ||
					"Sin descripción proporcionada para este proyecto inmobiliario."}
			</p>
