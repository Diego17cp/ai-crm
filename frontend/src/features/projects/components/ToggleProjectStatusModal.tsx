...
export const ToggleProjectStatusModal = ({
	isOpen,
	onClose,
	project,
}: Props) => {
	...
	const toggleProjectMutation = useToggleProjectStatusMutation(
								...
								<div className="text-sm text-gray-700 dark:text-gray-300 ml-1 leading-relaxed">
									{isActiva ? (
										<>
											...
											? Esta acción ocultará todas sus
											etapas y lotes asociados en ciertas
											vistas.
										</>
									) : (
										<>
											¿Deseas volver a activar el proyecto{" "}
											<strong className="text-gray-900 dark:text-white uppercase">
												{project.nombre}
											</strong>
											? Volverá a estar disponible para su
											operativa normal junto a todos sus
											componentes.
										</>
									)}
								</div>
