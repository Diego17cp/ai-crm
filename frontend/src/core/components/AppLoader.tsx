			...
			>
				...
				>
					<motion.div
						...
						className="p-4 bg-linear-to-r from-pink-500 to-emerald-500 rounded-full shadow-lg"
					>
					...
					<motion.div
						...
						className="absolute inset-0 bg-pink-400 rounded-full opacity-50"
					/>
				</motion.div>
				<motion.div
				...
				<motion.div
					...
					className="w-32 h-1 bg-linear-to-r from-pink-500 to-emerald-500 rounded-full"
				/>
			</motion.div>
		</div>
	);
