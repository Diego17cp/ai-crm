...
export class ChatsController {
	...
	getChatBySessionId = async (
		...
		try {
			...
			const chat = await this.chatUseCases.getChatBySessionId(
				String(sessionId),
			);
			res.json({
				success: true,
	...
	getLiveActiveChats = async (
		...
		try {
			...
			const activeChats = await this.chatUseCases.getLiveActiveChats(
				String(id_usuario),
			);
			res.json({
				success: true,
	...
	updateChatStatus = async (
		...
		try {
			...
			await this.chatUseCases.updateChatStatus(
				String(chatId),
