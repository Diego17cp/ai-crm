import { PrismaClient, Prisma, TipoPersona } from "generated/prisma/client";
import {
	ILeadsRepository,
...
export class PrismaLeadsRepository implements ILeadsRepository {
    ...
    async findByDocument(idTipoDoc: number, numero: string): Promise<LeadWithRelationsDTO | null> {
        return this.prisma.clientes.findFirst({
            where: {
